"""Distance metrics used by the independent Geodesic engine."""
...
def named_p_norm(name: str) -> float:
    """Return the p-norm associated with a named kernel metric."""
...
class Metric:
    ...
    def manhattan(a: Vector, b: Vector) -> float:
        """Return Manhattan/L1 distance between equal-length vectors."""
        Metric._validate_pair(a, b)
